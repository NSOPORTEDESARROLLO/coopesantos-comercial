<?php
  ...
  +----------------------------------------------------------------------+
  $Id: index.php,v 1.1 2017-12-10 06:12:32 Christopher Naranjo cnaranjo@nsoporte.com Exp $ */
...
function reportIVR_REPORT($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf)
{
    ...
    $oGrid->setTitle(_tr("New Services"));
    $oGrid->pagingShow(true); // show paging section.
    $oGrid->enableExport();   // enable export.
    $oGrid->setNameFile_Export(_tr("New Services"));
	...
	$arrColumns = array(_tr("Date"),_tr("Number"),_tr("Dest"),_tr("Service"));
