...
function reportIVR_REPORT($smarty, $module_name, $local_templates_dir, &$pDB, $arrConf)
{
    ...
    $oGrid->setTitle(_tr("Call to Ticket Report"));
    $oGrid->pagingShow(true); // show paging section.
    $oGrid->enableExport();   // enable export.
    $oGrid->setNameFile_Export(_tr("Call to Ticket"));
	...
	$arrColumns = array(_tr("Date"),_tr("Number"),_tr("IVR Menu"),_tr("Service"),_tr("Client"),_tr("Recording File"));
...
function createFieldFilter(){
    $arrFilter = array(
            "numero" => _tr("Number"),
            "ivrservice" => _tr("IVR Menu"),
	    "nservicio" => _tr("Service"),
	    "cliente"  => _tr("Client"),
                    );
